...
export const mathQuestions = [
  {
    question: "Qual é o resultado de 7 multiplicado por 8?",
    answers: [
  ...
  {
    question:
      "Se um triângulo tem dois ângulos de 60 graus, qual é o terceiro ângulo?",
    answers: [
      { text: "30 graus", correct: false },
      { text: "60 graus", correct: true },
      { text: "90 graus", correct: false },
...
export const sportsQuestions = [
  ...
  {
    question: "Quantos jogadores há em um time de vôlei em quadra?",
    answers: [
